...
urlpatterns = patterns('',
    ...
    (r'^StinkomanLE-9\\.4\\.1$', 'redirect_to', {'url': MEDIA_URL+"downloads/StinkomanLE-9.4.1.exe"}),
    ...
    (r'^login/$', 'stinkomanlevels.main.views.login'),
    (r'^logout/$', 'stinkomanlevels.main.views.logout'),
